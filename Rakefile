...
desc 'Run all specs'
task default: [:model_spec, :controller_spec, :service_spec]
...
task :controller_spec do
  spec.call('./spec/controllers/*_spec.rb')
end

desc 'Run service specs'
task :service_spec do
  spec.call('./spec/services/*_spec.rb')
end
